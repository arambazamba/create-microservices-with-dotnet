...
# Color theming
if [ -f ~/mnt/h/ms-learn-labs/aspnet-learn/setup/theme.sh ]
then
  . <(cat ~/mnt/h/ms-learn-labs/aspnet-learn/setup/theme.sh)
fi

if [ -f ~/mnt/h/ms-learn-labs/aspnet-learn/create-aks-exports.txt ]
then
  eval $(cat ~/mnt/h/ms-learn-labs/aspnet-learn/create-aks-exports.txt)
fi

if [ -f ~/mnt/h/ms-learn-labs/aspnet-learn/create-acr-exports.txt ]
then
  eval $(cat ~/mnt/h/ms-learn-labs/aspnet-learn/create-acr-exports.txt)
fi
